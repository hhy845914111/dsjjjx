#导入豆瓣网电影评论数据，绘制正态概率图，它接近正态分布吗？
from douban import *
#from rankit import *
"""Notice that the following part is intentionally
COPIED from the file of rankit.py because the normal
method of importing that file into this script does nothing
but return a run-time report and returned no error.
"""
